...
class MercadoPagoTest {
  ...
  static function getPublicKeyTest($site_id){
    $public_keys = array(
      ...
      "MLB" => "TEST-2880c3e1-b255-4d33-b5bb-8048a71b1509",
  ...
  static function getAccessTokenSellerTest($site_id){
    $access_tokens = array(
      ...
      "MLB" => "TEST-1442082636502980-071419-9a09ee050b349da1989ceb563ecbb362__LD_LA__-221203950",
  ...
  static function getEmailBuyerTest($site_id){
    $emails_test = array(
      ...
      "MLB" => "test_user_83885909@testuser.com",
